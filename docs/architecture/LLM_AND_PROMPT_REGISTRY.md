...
ceiling before dispatch and retains unknown usage. No automatic model escalation
or transport retry. See [Phase 1 authority and governance](RC4_CONVERSATIONAL_INTAKE.md).
