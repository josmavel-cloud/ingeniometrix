          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-[var(--color-muted)]">
                Usa esta ruta para entrar al workspace real aunque el portal publico
                siga en diseno. Al iniciar sesion aqui, la app te lleva directo a tus
                proyectos.
              </p>
            </div>
            ...
            <div className="brand-card-primary rounded-[30px] px-5 py-5">
              ...
              <p className="mt-3 font-[var(--font-heading)] text-xl font-semibold text-white">
                Crea una sesion ligera y entra al flujo productivo.
              </p>
        ...
        <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="surface-panel rounded-[32px] p-6 sm:p-8">
            ...
            <p className="mt-3 text-sm leading-7 text-[var(--color-muted)]">
              Esta sesion local te llevara directo a <span className="font-semibold text-[var(--color-ink)]">/projects</span>.
            </p>
