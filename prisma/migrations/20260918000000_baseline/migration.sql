...
-- CreateEnum
CREATE TYPE "MvpStepRunStatus" AS ENUM ('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'PARTIALLY_COMPLETED');
...
-- CreateTable
CREATE TABLE "MvpStepRun" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "userId" TEXT,
    "stepKey" TEXT NOT NULL,
    "status" "MvpStepRunStatus" NOT NULL DEFAULT 'PENDING',
    "provider" "Provider",
    "model" TEXT,
    "promptVersion" TEXT,
    ...
    "errorsJson" JSONB,
    "artifactDir" TEXT,
    "artifactManifestPath" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "MvpStepRun_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ProjectTemplateContentPlan" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    ...
    "qualityStatus" TEXT NOT NULL DEFAULT 'PLANNED',
    "sectionPlanJson" JSONB NOT NULL,
    "llmWavePlanJson" JSONB NOT NULL,
    "artifactManifestPath" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ProjectTemplateContentPlan_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ProjectEvidenceLedger" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "stepRunId" TEXT NOT NULL,
    "citationStyle" TEXT NOT NULL,
    "sourceRegistryJson" JSONB NOT NULL,
    ...
    CONSTRAINT "ProjectEvidenceLedger_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ProjectEvidenceCard" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "stepRunId" TEXT NOT NULL,
    "evidenceLedgerId" TEXT,
    ...
    "requiresFullText" BOOLEAN NOT NULL DEFAULT true,
    "sectionKeysJson" JSONB NOT NULL,
    "contentJson" JSONB NOT NULL,
    "artifactPath" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ProjectEvidenceCard_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ProjectSourceMaterialization" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "stepRunId" TEXT NOT NULL,
    "evidenceLedgerId" TEXT,
    "sourceId" TEXT NOT NULL,
    "referenceId" TEXT NOT NULL,
    "materializationType" TEXT NOT NULL,
    ...
    CONSTRAINT "ProjectSourceMaterialization_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ProjectSourceAsset" (
    "id" TEXT NOT NULL,
    "projectId" TEXT NOT NULL,
    "stepRunId" TEXT NOT NULL,
    "evidenceLedgerId" TEXT,
    ...
    "status" TEXT NOT NULL,
    "curationStatus" TEXT NOT NULL DEFAULT 'RAW',
    "curationScore" DOUBLE PRECISION,
    "sectionKey" TEXT,
    "pageNumber" INTEGER,
    "imagePath" TEXT,
    "structuredPath" TEXT,
    ...
    CONSTRAINT "ProjectSourceAsset_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ProjectReference_projectId_relevanceScore_idx" ON "ProjectReference"("projectId", "relevanceScore");

-- CreateIndex
CREATE INDEX "ProjectReference_projectId_selected_selectedOrder_idx" ON "ProjectReference"("projectId", "selected", "selectedOrder");
...
-- CreateIndex
CREATE INDEX "MvpStepRun_projectId_stepKey_startedAt_idx" ON "MvpStepRun"("projectId", "stepKey", "startedAt");

-- CreateIndex
CREATE INDEX "MvpStepRun_projectId_status_startedAt_idx" ON "MvpStepRun"("projectId", "status", "startedAt");

-- CreateIndex
CREATE INDEX "MvpStepRun_inputHash_idx" ON "MvpStepRun"("inputHash");

-- CreateIndex
CREATE INDEX "MvpStepRun_promptVersion_model_idx" ON "MvpStepRun"("promptVersion", "model");

-- CreateIndex
CREATE INDEX "ProjectTemplateContentPlan_projectId_createdAt_idx" ON "ProjectTemplateContentPlan"("projectId", "createdAt");

-- CreateIndex
CREATE INDEX "ProjectTemplateContentPlan_stepRunId_idx" ON "ProjectTemplateContentPlan"("stepRunId");

-- CreateIndex
CREATE INDEX "ProjectTemplateContentPlan_templateKey_citationStyle_idx" ON "ProjectTemplateContentPlan"("templateKey", "citationStyle");

-- CreateIndex
CREATE INDEX "ProjectEvidenceLedger_projectId_createdAt_idx" ON "ProjectEvidenceLedger"("projectId", "createdAt");

-- CreateIndex
CREATE INDEX "ProjectEvidenceLedger_stepRunId_idx" ON "ProjectEvidenceLedger"("stepRunId");

-- CreateIndex
CREATE INDEX "ProjectEvidenceLedger_citationStyle_idx" ON "ProjectEvidenceLedger"("citationStyle");

-- CreateIndex
CREATE INDEX "ProjectEvidenceCard_projectId_sourceId_idx" ON "ProjectEvidenceCard"("projectId", "sourceId");

-- CreateIndex
CREATE INDEX "ProjectEvidenceCard_projectId_referenceId_idx" ON "ProjectEvidenceCard"("projectId", "referenceId");

-- CreateIndex
CREATE INDEX "ProjectEvidenceCard_projectId_qualityStatus_idx" ON "ProjectEvidenceCard"("projectId", "qualityStatus");

-- CreateIndex
CREATE INDEX "ProjectEvidenceCard_stepRunId_idx" ON "ProjectEvidenceCard"("stepRunId");

-- CreateIndex
CREATE INDEX "ProjectEvidenceCard_evidenceLedgerId_idx" ON "ProjectEvidenceCard"("evidenceLedgerId");

-- CreateIndex
CREATE INDEX "ProjectSourceMaterialization_projectId_sourceId_idx" ON "ProjectSourceMaterialization"("projectId", "sourceId");

-- CreateIndex
CREATE INDEX "ProjectSourceMaterialization_projectId_referenceId_idx" ON "ProjectSourceMaterialization"("projectId", "referenceId");

-- CreateIndex
CREATE INDEX "ProjectSourceMaterialization_projectId_status_idx" ON "ProjectSourceMaterialization"("projectId", "status");

-- CreateIndex
CREATE INDEX "ProjectSourceMaterialization_stepRunId_idx" ON "ProjectSourceMaterialization"("stepRunId");

-- CreateIndex
CREATE INDEX "ProjectSourceMaterialization_evidenceLedgerId_idx" ON "ProjectSourceMaterialization"("evidenceLedgerId");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_projectId_sourceId_idx" ON "ProjectSourceAsset"("projectId", "sourceId");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_projectId_referenceId_idx" ON "ProjectSourceAsset"("projectId", "referenceId");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_projectId_assetKind_idx" ON "ProjectSourceAsset"("projectId", "assetKind");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_projectId_curationStatus_idx" ON "ProjectSourceAsset"("projectId", "curationStatus");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_projectId_sectionKey_idx" ON "ProjectSourceAsset"("projectId", "sectionKey");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_projectId_status_idx" ON "ProjectSourceAsset"("projectId", "status");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_stepRunId_idx" ON "ProjectSourceAsset"("stepRunId");

-- CreateIndex
CREATE INDEX "ProjectSourceAsset_evidenceLedgerId_idx" ON "ProjectSourceAsset"("evidenceLedgerId");
...
-- AddForeignKey
ALTER TABLE "MvpStepRun" ADD CONSTRAINT "MvpStepRun_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MvpStepRun" ADD CONSTRAINT "MvpStepRun_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectTemplateContentPlan" ADD CONSTRAINT "ProjectTemplateContentPlan_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectTemplateContentPlan" ADD CONSTRAINT "ProjectTemplateContentPlan_stepRunId_fkey" FOREIGN KEY ("stepRunId") REFERENCES "MvpStepRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectEvidenceLedger" ADD CONSTRAINT "ProjectEvidenceLedger_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectEvidenceLedger" ADD CONSTRAINT "ProjectEvidenceLedger_stepRunId_fkey" FOREIGN KEY ("stepRunId") REFERENCES "MvpStepRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectEvidenceCard" ADD CONSTRAINT "ProjectEvidenceCard_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectEvidenceCard" ADD CONSTRAINT "ProjectEvidenceCard_stepRunId_fkey" FOREIGN KEY ("stepRunId") REFERENCES "MvpStepRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectEvidenceCard" ADD CONSTRAINT "ProjectEvidenceCard_evidenceLedgerId_fkey" FOREIGN KEY ("evidenceLedgerId") REFERENCES "ProjectEvidenceLedger"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSourceMaterialization" ADD CONSTRAINT "ProjectSourceMaterialization_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSourceMaterialization" ADD CONSTRAINT "ProjectSourceMaterialization_stepRunId_fkey" FOREIGN KEY ("stepRunId") REFERENCES "MvpStepRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSourceMaterialization" ADD CONSTRAINT "ProjectSourceMaterialization_evidenceLedgerId_fkey" FOREIGN KEY ("evidenceLedgerId") REFERENCES "ProjectEvidenceLedger"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSourceAsset" ADD CONSTRAINT "ProjectSourceAsset_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSourceAsset" ADD CONSTRAINT "ProjectSourceAsset_stepRunId_fkey" FOREIGN KEY ("stepRunId") REFERENCES "MvpStepRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectSourceAsset" ADD CONSTRAINT "ProjectSourceAsset_evidenceLedgerId_fkey" FOREIGN KEY ("evidenceLedgerId") REFERENCES "ProjectEvidenceLedger"("id") ON DELETE CASCADE ON UPDATE CASCADE;
